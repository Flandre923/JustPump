...
public class TextureEditBox  extends AbstractWidget implements Renderable {
    ...
    private static final WidgetSprites CUSTOM_SPRITES = new WidgetSprites(TEXTURE, TEXTURE);
    private static final int textureWidth = 300;
    private static final int textureHeight = 200;
    private static final int uX = 48;
    private static final int vY = 144;
    private static final int uWidth = 79;
    private static final int vHeight = 15;
    ...
    public TextureEditBox(Font font, int width, int height, Component message) {
        this(font, 0, 0, width, height, message);
    }

    public TextureEditBox(Font font, int x, int y, int width, int height, Component message) {
        this(font, x, y, width, height, null, message);
    }

    public TextureEditBox(Font font, int x, int y, int width, int height, @Nullable EditBox editBox, Component message) {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        if (this.isVisible()) {
            if (this.bordered) {
//                ResourceLocation texture = CUSTOM_SPRITES.get(this.isActive(), this.isFocused());
//                guiGraphics.blitSprite(texture, this.getX(), this.getY(), this.getWidth(), this.getHeight(),this.uX,this.vY,this.uWidth,this.vHeight);
                guiGraphics.blit(TEXTURE,this.getX(),this.getY(),this.getWidth(),this.getHeight(),this.uX,this.vY,this.uWidth,this.vHeight,this.textureWidth,this.textureHeight);
            }
